package com.example.springboot3jwtauthentication.utils.constants;
...
public final class ResponseMessageConstants {
    ...
    public static final String EMAIL_ALREADY_EXISTS_ERROR_MESSAGE = "Email already exists";
    ...
    //Post Error Messages
    public static final String POST_NOT_FOUND_ERROR_MESSAGE = "Post not found.";
